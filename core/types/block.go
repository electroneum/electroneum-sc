...
// IBFTHashWithRoundNumber gets the hash of the Header with Only commit seal set to its null value
func (h *Header) IBFTHashWithRoundNumber(round uint32) common.Hash {
