...
func (b *BlockGen) AddTxWithChain(bc *BlockChain, tx *types.Transaction) {
	...
	emptyPriorityTransactorMap := make(common.PriorityTransactorMap)
	receipt, err := ApplyTransaction(b.config, bc, &b.header.Coinbase, b.gasPool, b.statedb, b.header, tx, &b.header.GasUsed, vm.Config{}, &emptyPriorityTransactorMap)
	if err != nil {
		panic(err)
	}
