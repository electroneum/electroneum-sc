...
var (
	file_messages_management_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
	file_messages_management_proto_msgTypes  = make([]protoimpl.MessageInfo, 21)
	file_messages_management_proto_goTypes   = []any{
