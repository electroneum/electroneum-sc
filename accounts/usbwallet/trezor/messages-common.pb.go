...
var (
	file_messages_common_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
	file_messages_common_proto_msgTypes  = make([]protoimpl.MessageInfo, 11)
	file_messages_common_proto_goTypes   = []any{
