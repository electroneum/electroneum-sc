...
import (
	...
	"github.com/electroneum/electroneum-sc/les/vflux"
	vfc "github.com/electroneum/electroneum-sc/les/vflux/client"
...
func New(stack *node.Node, config *ethconfig.Config) (*LightEthereum, error) {
	...
	leth := &LightEthereum{
		...
		merger:          merger,
		engine:          ethconfig.CreateConsensusEngine(stack, chainConfig, config, nil, false, false, chainDb),
