...
var (
	...
	StagenetChainConfig = &ChainConfig{
		...
		LondonBlock:         big.NewInt(0),
		ArrowGlacierBlock:   nil,
		BrasiliaBlock:       big.NewInt(5), // TODO: set proper block height
		IBFT: &IBFTConfig{
			BlockPeriodSeconds:       5,
			EpochLength:              17280,
			ProposerPolicy:           0,
	...
	AllEthashProtocolChanges = &ChainConfig{big.NewInt(1337), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, new(EthashConfig), nil, nil, big.NewInt(0), big.NewInt(0), big.NewInt(0), common.Address{}, nil}
	...
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
	AllCliqueProtocolChanges = &ChainConfig{big.NewInt(1337), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, nil, &CliqueConfig{Period: 0, Epoch: 30000}, nil, big.NewInt(0), big.NewInt(0), big.NewInt(0), common.Address{}, nil}

	TestChainConfig = &ChainConfig{big.NewInt(1), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, new(EthashConfig), nil, nil, big.NewInt(0), big.NewInt(0), big.NewInt(0), common.Address{}, nil}
...
type ChainConfig struct {
	...
	BrasiliaBlock       *big.Int `json:"brasiliaBlock,omitempty"`       // Brasilia switch block (nil = no fork, 0 = already activated)
...
// IsBrasilia returns whether num is either equal to the Brasilia fork block or greater.
func (c *ChainConfig) IsBrasilia(num *big.Int) bool {
	return isForked(c.BrasiliaBlock, num)
}
