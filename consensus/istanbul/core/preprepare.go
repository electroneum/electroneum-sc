...
func (c *core) handlePreprepareMsg(preprepare *qbfttypes.Preprepare) error {
	...
	if preprepare.Round.Uint64() > 0 {
		if err := isJustified(preprepare.Sequence, preprepare.Round, preprepare.Proposal, preprepare.JustificationRoundChanges, preprepare.JustificationPrepares, c.QuorumSize(), c.valSet); err != nil {
