...
```shell
go get github.com/electroneum/electroneum-sc/cmd/checkpoint-admin
```
...
*CHECKPOINT_HASH is obtained based on this [calculation method](https://github.com/electroneum/electroneum-sc/blob/master/params/config.go#L251).*
