...
import (
	...
	"github.com/electroneum/electroneum-sc/console"
...
var (
	...
	consoleCommand = cli.Command{
		...
		Description: `
The ETN-SC console is an interactive shell for the JavaScript runtime environment
...
func remoteConsole(ctx *cli.Context) error {
	...
	if endpoint == "" {
		...
		if path != "" {
			if ctx.GlobalBool(utils.StagenetFlag.Name) {
				path = filepath.Join(path, "stagenet")
