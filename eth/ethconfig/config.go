...
func CreateConsensusEngine(stack *node.Node, chainConfig *params.ChainConfig, config *Config, notify []string, noverify bool, PrioritiseElectroneum bool, db ethdb.Database) consensus.Engine {
